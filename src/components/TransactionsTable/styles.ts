...
export const TableHeadCell = styled.th`
  padding: 14px 20px;
  text-align: left;
  border-right: 1px solid ${(props) => props.theme.COLORS.tableHeaderBackground};
  border-bottom: 1px solid
    ${(props) => props.theme.COLORS.tableHeaderBackground};
...
export const ActionsBtn = styled.button<{ $variant: string }>`
  padding: 1px 5px;
  border-radius: 3px;
